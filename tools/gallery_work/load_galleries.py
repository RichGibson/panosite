...
# load_galleries.py - 
# SUT: make a list of curl commands to download galleries.

# later
#walk the gallery pages starting with
# galleries_1.html http://gigapan.com/galleries?page=1&per_page=10
# parse each page, load it into our galleries, load the gigapans for the gallery
# and download the gigapans.json files.

for page in range(1,109):
    print "curl -o galleries_%02i.html http://gigapan.com/galleries?page=%i" % (page, page)


sys.exit(2)
# nothing after this line matters, yet.
########################################################################

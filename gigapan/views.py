...
def gigapans_parent(request, page, user_id, format):
	...
	if re.match('kml',format):
		...
		return render_to_response('site_master.html', {'nav':nav,'lookAt':lookAt,'start':start,'end':end, 'gigapans': gigapans,'page':page, 'prev':page-1, 'next':page+1, 'page_template': 'gigapans.html', 'header':header })
